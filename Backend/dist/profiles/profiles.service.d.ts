...
export declare class ProfilesService {
    ...
    getMyProfile(currentUser: AuthenticatedUser): Promise<{
        profile: null;
        completion: {
            percentage: number;
    ...
    savePersonalDetails(currentUser: AuthenticatedUser, dto: SavePersonalDetailsDto): Promise<{
        profile: {
            id: string;
            userId: string;
            profileUid: string | null;
    ...
    saveReligiousDetails(currentUser: AuthenticatedUser, dto: SaveReligiousDetailsDto): Promise<{
        profile: {
            id: string;
            userId: string;
            profileUid: string | null;
    ...
    saveLocationDetails(currentUser: AuthenticatedUser, dto: SaveLocationDetailsDto): Promise<{
        profile: {
            id: string;
            userId: string;
            profileUid: string | null;
    ...
    saveProfessionalDetails(currentUser: AuthenticatedUser, dto: SaveProfessionalDetailsDto): Promise<{
        profile: {
            id: string;
            userId: string;
            profileUid: string | null;
    ...
    saveAdditionalDetails(currentUser: AuthenticatedUser, dto: SaveAdditionalDetailsDto): Promise<{
        profile: {
            id: string;
            userId: string;
            profileUid: string | null;
    ...
    private finalizeProfileUpdate;
    private getUserOrThrow;
    private ensureProfileExists;
    private generateProfileUid;
